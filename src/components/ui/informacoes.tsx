    ...
    return(
        <section className="w-full bg-white flex justify-center items-center py-10 pb-35">
            <div className="max-w-[1500px] w-full flex flex-col gap-10 justify-center items-center md:justify-start md:items-start px-8">
                <h1 className="font-semibold text-2xl">Mais informações</h1>
                <div className="grid grid-cols-1 lg:grid-cols-5 md:grid-cols-3 gap-8 flex-wrap">
                    <div className="flex flex-col justify-start items-start gap-1 p-4 transition-all duration-500 border-2 border-neutral-300 cursor-pointer hover:border-neutral-900 w-[16rem] rounded-2xl">
                        <FontAwesomeIcon icon={faMobileScreen} style={{ fontSize: "32px", paddingBottom: "15px"}} className="text-[#222222]" />
                        <h1 className="font-semibold text-[17px]">Aplicativo</h1>
                    ...
                    <div className="flex flex-col justify-start items-start gap-1 p-4  transition-all duration-500 border-2 border-neutral-300 cursor-pointer hover:border-neutral-900 w-[16rem] rounded-2xl">
                        ...
                        <h1 className="font-semibold text-[17px]">Comprovantes</h1>
                    ...
                    <div className="flex flex-col justify-start items-start gap-1 p-4 transition-all duration-500 border-2 border-neutral-300 cursor-pointer hover:border-neutral-900 w-[16rem] rounded-2xl">
                        <Image 
                            ...
                            className="pb-3"
                        />
                        <h1 className="font-semibold text-[17px]">Atendimento</h1>
                    ...
                    <div className="flex flex-col justify-start items-start gap-1 p-4 transition-all duration-500 border-2 border-neutral-300 cursor-pointer hover:border-neutral-900 w-[16rem] rounded-2xl">
                        ...
                        <h1 className="font-semibold text-[17px]">Transferências</h1>
