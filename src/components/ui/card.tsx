...
export const Card = () => {
  return (
    <div className="w-full mx-auto flex flex-col  lg:flex-row min-h-[43rem] bg-white p-8 md:p-12 justify-between items-center shadow-sm">
      <div className="max-w-[100rem] pl-0 md:pl-0 lg:pl-10 flex-col lg:flex-row flex justify-between items-center mx-auto py-24 w-full">
        <div className="px-2 gap-3 text-center lg:text-start md:px-8 flex flex-col justify-center items-start lg:w-[60rem] mb-8 lg:mb-0 w-full">
              ...
              <span className="text-[#31A7FF]">NordisBank Card</span> — Seu Estilo, Sua Liberdade Financeira
            </h1>
            <div className="w-32 mx-auto lg:mx-0 h-1 bg-gray-700 my-4" data-aos="fade-right" data-aos-duration="950"></div>
              ...
              Desfrute de vantagens premium como <span className="text-[#31A7FF] font-semibold">zero anuidade</span>, 
              até <span className="text-[#31A7FF] font-semibold">3% de cashback</span> em todas as compras e 
            ...
            <button className="mt-6 cursor-pointer hidden lg:block bg-[#31A7FF] hover:bg-[#3179ff] text-white font-bold py-3 px-6 rounded-lg transition-colors duration-300" data-aos="fade-right" data-aos-duration="1200">
              Solicite Agora
            </button>
        </div>
        ...
        <div className="w-full flex-col gap-5 lg:w-[40rem] flex justify-center items-center" data-aos="fade-right">
            ...
            <button className="mt-6 cursor-pointer block lg:hidden bg-[#31A7FF] hover:bg-[#3179ff] text-white font-bold py-3 px-6 rounded-lg transition-all">
            Solicite Agora
            </button>
        </div>
      </div>
