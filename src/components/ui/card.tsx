...
export const Card = () => {
  return (
    <div className="w-full mx-auto flex flex-col  lg:flex-row min-h-[43rem] bg-white p-8 md:p-12 justify-between items-center shadow-sm">
      <div className="max-w-[150rem] pl-0 md:pl-0 lg:pl-10 flex-col lg:flex-row flex justify-between items-center mx-auto py-24 w-full">
        <div className="px-2 gap-3 text-center lg:text-start md:px-4 flex flex-col justify-center items-start lg:w-[60rem] mb-8 lg:mb-0 w-full">
              <h1 id="titulo" className="text-[#191C1F] text-3xl md:text-4xl lg:text-6xl font-bold" data-aos="fade-right" data-aos-duration="900">
              <span className="text-[#191C1F]">NordisBank Card</span> — Seu Estilo, Sua Liberdade Financeira
            </h1>
            ...
            <button className="mt-6 cursor-pointer hidden lg:block bg-black hover:bg-[#1c1c1d] text-white font-bold py-3 px-6 rounded-lg transition-colors duration-300" data-aos="fade-right" data-aos-duration="1200">
              Solicite Agora
            </button>
        </div>
        ...
        <div className="w-full flex-col gap-5 lg:w-[40rem] flex justify-center items-center" data-aos="fade-right">
            ...
            <button className="mt-6 cursor-pointer block lg:hidden bg-black hover:bg-[#1c1c1d] text-white font-bold py-3 px-6 rounded-lg transition-all">
            Solicite Agora
            </button>
        </div>
      </div>
